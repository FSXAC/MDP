...
def build():
	...
	newRecipe.setIngredients(['minecraft:stone_slab', 'minecraft:stone_slab'])
	newRecipe.setResult('minecraft:smooth_stone', 1)
	makeRecipe(recipesDir, 'smooth_stone', newRecipe)
